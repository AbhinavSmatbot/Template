...
import {FormControl,OutlinedInput,InputLabel,MenuItem,Select,Chip,Radio, NativeSelect} from '@mui/material';
import { Link } from 'react-router-dom';
import { AiTwotoneSound } from 'react-icons/ai';
import { BiSolidBellRing } from 'react-icons/bi';
import { FaKey } from 'react-icons/fa';
import { AiOutlineSearch } from 'react-icons/ai';
import {All_languages} from './Templates_languages';
                           ...
                           <div className='text-left'>
                             ...
                             <div>
                                   ...
                                   >
                                        ...
                                        key={item.value}
                                        value={item.name}
                                        style={{...getStyles(item.name, languages),fontSize:"14px"}}
                                        >
                                        {item.name}
                                        </MenuItem>
                                        ))}
