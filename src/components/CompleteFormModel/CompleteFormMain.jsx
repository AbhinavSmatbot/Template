...
export default function CompleteFormMain(props) {
          ...
          <div className='float-left w-full h-full'>
            <div className='flex flex-row justify-around w-full h-full'>
              <div className='float-left w-[20%]'>
                <h1 className='!text-sm !font-Secondary text-[black] p-1'>Screens</h1>
                 <ScreenFormType/>
              </div>
              <div className='float-left w-[50%] border-r border-l border-[#d2d2d3] overflow-y-auto overflow-x-hidden'>
                <h1 className='!text-sm !font-Secondary text-[black] p-2'>Edit content</h1>
                <EditFormType/>

              </div>
              <div className='float-left w-[30%] p-1'>
